...
font_path = "font/NotoSansGujarati-Regular.ttf"
...
activity_list = [
    "પાપડ", "અથાણું", "ખેતી", "આમલી", "સંશોધન વિષય", "લેખન", "સ્વાસ્થ્ય", "ખાસ વાનગી", "ખરીદી", "ચર્ચા", "આયોજન", "દુખની ઘટના", "ઘરની બહાર", "અન્ય", "કંઈ નથી", "ભૂલી ગઈ"
]
